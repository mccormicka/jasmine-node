...
TerminalReporter.prototype.ANSIColors = {
    pass:    function() { return '\u001b[32m'; }, // Green
    fail:    function() { return '\u001b[31m'; }, // Red
    neutral: function() { return '\u001b[0m';  }  // Normal
};
...
//_.extend(TerminalVerboseReporter, TerminalReporter);
_.extend(TerminalVerboseReporter.prototype, TerminalReporter.prototype);
...
TerminalVerboseReporter.prototype.buildMessagesFromResults_ = function(messages, results, depth) {
...
TerminalVerboseReporter.prototype.indentMessage_ = function(message, indentCount) {
  var _indent = '';
...
// Append the reporters to jasmine
if (jasmine) {
    jasmine.TerminalReporter = TerminalReporter;
    jasmine.TerminalVerboseReporter = TerminalVerboseReporter;
}
//
// Exports
//
