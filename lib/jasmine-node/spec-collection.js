...
var createSpecObj = function(path, root) {
  return {
    ...
    relativePath: function() { return this.path().replace(root, '').replace(/^[\/\\]/, '').replace(/\\/g, '/'); },
    directory: function() { return this.path().replace(/[\/\\][\s\w\.\-]*$/, "").replace(/\\/g, '/'); },
    relativeDirectory: function() { return this.relativePath().replace(/[\/\\][\s\w\.\-]*$/, "").replace(/\\/g, '/'); },
    filename: function() { return this.path().replace(/^.*[\\\/]/, ''); }
  };
};
