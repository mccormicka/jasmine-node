...
// Compile and execute Jasmine, we append jasmine; to the end so that it
// returns the jasmine object once run.
...
// Reporter uses exports instead of the jasmine pattern in case someone needs
// to `require` it for some reason. Let's just append it to Jasmine instead of
// having it append itself to the global context
...
// Load Helpers located in a folder that match `matcher`
jasmine.loadHelpersInFolder = function(folder, matcher)
{
  ...
  var folderStats = fs.statSync(folder);
