exports.executeJsRunner = function (specCollection, done, jasmineEnv, setupFile, coverage) {
    var specs,
        ...
        template = fs.readFileSync(
            (__dirname + '/requirejs-config-runner.js'),
            'utf8'
        ),
        ...
        buildNewContext = function (spec) {
            ...
            //Add support for jscoverage. --cover
            if (coverage.cover) {
                context._$jscoverage = jasmineEnv.globals._$jscoverage;
                context._$jscoverage_cond = jasmineEnv.globals._$jscoverage_cond;
                context._$jscoverage_done = jasmineEnv.globals._$jscoverage_done;
                context._$jscoverage_init = jasmineEnv.globals._$jscoverage_init;
            }
