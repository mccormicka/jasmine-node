...
jasmine.Env.prototype.xdescribe = function(description, specDefinitions) {
    var suite = new jasmine.Suite(this, description, null, this.currentSuite);
    suite.skipped = true;
    suite = this.describe_(suite, specDefinitions);
    suite.execute = function(onComplete){
        var i;
        var specs = this.specs_;
        for(i in specs){
            if(!specs[i].skipped){
                specs[i].skipped = true;
                specs[i].results_.skippedCount ++;
            }

        }
        suite.finish(onComplete);
    }
    return suite;
};
...
jasmine.Suite.prototype.afterAll = function(afterAllFunction) {
    afterAllFunction.typeName = 'afterAll';
    this.after_.push(afterAllFunction);
};
